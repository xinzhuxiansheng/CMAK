...
resolvers += "Local Maven Repository" at "file://D:/software/dev_soft/Maven/repository/repos"
libraryDependencies ++= Seq(
  ...
  "org.apache.kafka" %% "kafka" % "2.4.1.clientid" exclude("log4j","log4j") exclude("org.slf4j", "slf4j-log4j12") force(),
